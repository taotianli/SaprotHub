...
try:
  ...
  try:
      ...
      if not is_fork_installed:
          ...
          print(f"SaprotHub is installed successfully!")
      else:
  ...
  def change_model_type(change):
      ...
      if model_type_value == "Trained by yourself on ColabSeprot":
        ...
        new_model_arg_box = ipywidgets.Textarea(
                        value=None,
                        placeholder='Enter SeprotHub model ids, one line for one model.\ne.g.:\nSeprotHub/model_1\nSeprotHub/model_2\n\nNote: These models should have the same model size and configuration, i.e. both are 650M or 35M. Otherwise, errors may occur during the prediction process!',
